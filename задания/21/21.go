...
// Ответ: паттерн Адаптер применяется в Domain Driven Design
// в качестве прослойки при обмене данными между слоями.
// В голанге реализуется через интерфейсы, чаще всего не вручную,
// а генерацией кода.
